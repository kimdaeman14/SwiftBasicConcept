...
let height = Int8(5) // 5라는 값을 int8형으로 변환해서 height이라는 프로퍼티에 저장.
let width = 10
//let area = height * width
//height와 width의 타입이 다르기 때문에 에러 발생
...
//변환되기 전에 이미 h가 UInt8형으로 선언되어 있으므로 그 자료형에 맞춰가서 Uint8형으로 추론되어 적용되기 때문이다.
